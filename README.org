...
POST https://viper-fredc.vercel.app/viper/api/pass/apple
...
const stream = got(`https://viper-fredc.vercel.app/viper/api/pass/apple`, { json, isStream: true });
...
#+BEGIN_SRC restclient
POST https://viper-fredc.vercel.app/viper/api/pass/google
Content-Type: application/json
